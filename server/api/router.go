...
func createRouter(prefix string, svr *server.Server) *mux.Router {
	...
	router.HandleFunc("/api/v1/newplugin/load", pluginHandler.LoadPlugin).Methods("POST")
	router.HandleFunc("/api/v1/newplugin/update", pluginHandler.UpdatePlugin).Methods("POST")
	router.HandleFunc("/api/v1/newplugin/unload", pluginHandler.UnloadPlugin).Methods("POST")
